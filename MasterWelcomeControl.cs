...
internal sealed class MasterWelcomeControl : UserControl
{
    ...
    public event Action? CreateMasterRequested;
    ...
    private Control BuildMasterOptions()
    {
        ...
        var create = UiTheme.PrimaryButton("＋ Create new Master File");
        create.AutoSize = false;
        create.Size = new Size(212, 40);
        create.Margin = new Padding(5, 0, 5, 0);
        create.Click += (_, _) => CreateMasterRequested?.Invoke();
        choices.Controls.Add(create);
    ...
    private Control BuildSignInCard()
    {
        ...
        var signIn = UiTheme.PrimaryButton("Sign in and open Master");
    ...
    public void RefreshState()
    {
        ...
        else
        {
            _selection.Text = localLinked
                ? $"Selected: Local / file share  •  {_data.Settings.SharedMasterPath}"
                : "No local or file-share Master is selected.";
